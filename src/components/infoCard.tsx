...
const InfoCard : NextPage<Props>= (props)=>{
    const{title, label,imageURL,studentCount
    ...
    return(
        <Card>
            ...
            <Card.Footer isBlurred css={{position:'absolute', bgBlur:'#0f1111466', bottom:0 }}>
                <Row>
                    <Col>
                    ...
                    <Row justify="flex-end">
                        <Button flat auto rounded color='primary'></Button>
